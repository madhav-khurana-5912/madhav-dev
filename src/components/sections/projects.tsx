...
const projects = [
  {
    ...
    liveUrl: "https://school-erpa.vercel.app",
    repoUrl: "#",
    stars: 123,
    forks: 45,
  },
  {
    ...
    tags: ["Next.js", "Firebase", "Genkit", "Tailwind CSS"],
    liveUrl: "https://fitgenius-beta.vercel.app",
    repoUrl: "#",
    stars: 256,
    forks: 88,
  },
  {
    ...
    liveUrl: "https://cuisine-compass-black.vercel.app",
    repoUrl: "#",
    stars: 98,
    forks: 12,
  },
...
export function Projects() {
  return (
    <section id="projects" className="py-12 md:py-20 container mx-auto px-4 md:px-6">
